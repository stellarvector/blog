...
category: "crypto"
tags: ["rsa"]
summary: "Comprehensive walkthrough of three RSA challenges from CTF101, covering basic decryption, factoring using online tools, and exploiting totient multiples from leaked private exponents."
...
This gives us almost instantly a factor for `n`, from which we can get the flag: <span class="flag">`sv{l34ks_m4k3s_3v3ryth1ng_34sy3r}`</span>.
